...
/**
 * The <code>UsnoA20Star</code> represents a star data in the 
 * USNO-A1.0 CD-ROMs.
 *
...
public class UsnoA20Star extends UsnoAStar {
	/**
	 * Constructs an empty <code>UsnoA20Star</code>. It is used in 
	...
	/**
	 * Constructs a <code>UsnoA20Star</code> with data read from 
	 * CD-ROMs.
	 ...
	 */
	public UsnoA20Star ( short file_numer,
						 int star_number,
						 Coor coor,
						 boolean valid_R_mag,
						 short R_mag10,
