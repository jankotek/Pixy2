...
/**
 * The <code>LhsStar</code> represents a star data in the Luyten
 * Half-Second Catalogue.
 *
 * @author  Seiichi Yoshida (comet@aerith.net)
 * @version 2003 March 7
 */

public class LhsStar extends DefaultStar {
	/**
	 * Constructs an empty <code>LhsStar</code>. It is used in 
	...
	/**
	 * Constructs an <code>LhsStar</code> with data read from the
	 * catalog file.
	...
	public String getCatalogName ( ) {
		return "Luyten Half-Second Catalogue";
	}
