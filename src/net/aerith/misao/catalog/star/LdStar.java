...
/**
 * The <code>LdStar</code> represents a star data in the Lennart 
 * Dahlmark's New Variable Stars.
 *
 * @author  Seiichi Yoshida (comet@aerith.net)
 * @version 2003 March 7
 */

public class LdStar extends DefaultStar {
	/**
	 * Constructs an empty <code>LdStar</code>. It is used in 
	...
	/**
	 * Constructs an <code>LdStar</code> with data read from the
	 * catalog file.
	...
	public String getCatalogName ( ) {
		return "Lennart Dahlmark's New Variable Stars";
	}
