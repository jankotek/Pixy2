...
/**
 * The <code>NgcStar</code> represents a star data of New General 
 * Catalogue (NGC).
 *
...
public class NgcStar extends CatalogStar {
	/**
	 * The number.
	 */
	...
	/**
	 * Constructs an empty <code>NgcStar</code>. It is used in 
	...
	/**
	 * Constructs a <code>NgcStar</code> with data read from the
	 * catalog file.
	 * @param number the star number.
	 * @param coor   the R.A. and Decl.
	 * @param type   the type.
	 */
	public NgcStar ( int number,
					 Coor coor,
					 String type )
	{
		super();
