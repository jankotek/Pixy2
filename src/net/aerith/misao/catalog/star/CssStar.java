...
/**
 * The <code>CssStar</code> represents a star data in the General 
...
public class CssStar extends DefaultStar {
	/**
	 * Constructs an empty <code>CssStar</code>. It is used in 
	...
	/**
	 * Constructs an <code>CssStar</code> with data read from the
	 * catalog file.
