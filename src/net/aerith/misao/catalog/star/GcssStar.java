...
/**
 * The <code>GcssStar</code> represents a star data in the General 
...
public class GcssStar extends DefaultStar {
	/**
	 * Constructs an empty <code>GcssStar</code>. It is used in 
	...
	/**
	 * Constructs an <code>GcssStar</code> with data read from the
	 * catalog file.
