...
/**
 * The <code>FloatBuffer</code> is a class of float array for an image
 * buffer.
 *
...
public class FloatBuffer extends Buffer {
	/**
	 * The buffer to keep float values of the image.
	 */
	private float[] pixels;

	/**
	 * Constructs a <code>FloatBuffer</code>, allocates the buffer.
	 * @param allocate_size the buffer size.
	 */
	public FloatBuffer ( Size allocate_size ) {
		pixels = new float[ allocate_size.getWidth() * allocate_size.getHeight() ];
		size = allocate_size;
	}
	...
	public Buffer cloneBuffer ( ) {
		FloatBuffer new_buffer = new FloatBuffer(size);
