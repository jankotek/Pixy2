...
/**
 * The <code>BrightnessBasedPairMaker</code> is a class to make pairs
 ...
 * brightest one is selected as a counterpart. If all stars in the 
 * specified search area are too faint over the specified difference,
...
public class BrightnessBasedPairMaker extends Operation {
	/**
	...
	/**
	 * Constructs a <code>BrightnessBasedPairMaker</code> with two 
	 * lists of stars. 
	 * @param first_list  the first list of stars.
	 * @param second_list the second list of stars.
	 */
	public BrightnessBasedPairMaker ( StarList first_list, StarList second_list ) {
		...
		throws Exception
	{
		...
		monitor_set.addMessage("[Making pairs based on brightness]");
