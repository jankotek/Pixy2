...
/**
 * <b>XmlSbigImage</b> is generated by Relaxer based on pixy.rlx.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="sbig-image"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="sbig-image"/&gt;
 * </pre>
 ...
 */
public class XmlSbigImage extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
     ...
     * @param stack
     */
    public XmlSbigImage(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public XmlSbigImage(Document doc) {
     ...
     * @param element
     */
    public XmlSbigImage(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlSbigImage</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlSbigImage</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlSbigImage</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("sbig-image");
        int size;
     ...
     * for the <code>XmlSbigImage</code>.
     *
     * @param element
     * @return boolean
     */
     ...
     * is valid for the <code>XmlSbigImage</code>.
