...
/**
 * <b>XmlCenter</b> is generated by Relaxer based on pixy.rlx.
 ...
 */
public class XmlCenter extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
    private String ra;
    private String decl;
     ...
     * @param element
     */
    public XmlCenter(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlCenter</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlCenter</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlCenter</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * is valid for the <code>XmlCenter</code>.
