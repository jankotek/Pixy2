...
/**
 * <b>XmlImported</b> is generated by Relaxer based on pixy.rlx.
 ...
 */
public class XmlImported extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
     ...
     * @param stack
     */
    public XmlImported(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public XmlImported(Document doc) {
     ...
     * @param element
     */
    public XmlImported(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlImported</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlImported</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlImported</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("imported");
        int size;
     ...
     * is valid for the <code>XmlImported</code>.
