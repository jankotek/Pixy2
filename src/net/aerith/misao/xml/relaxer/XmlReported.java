...
/**
 * <b>XmlReported</b> is generated by Relaxer based on pixy.rlx.
 ...
 */
public class XmlReported extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
    private String to;
     ...
     * @param stack
     */
    public XmlReported(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public XmlReported(Document doc) {
     ...
     * @param element
     */
    public XmlReported(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlReported</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlReported</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlReported</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("reported");
        int size;
     ...
     * is valid for the <code>XmlReported</code>.
