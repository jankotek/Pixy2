...
/**
 * <b>XmlUnofficial</b> is generated by Relaxer based on pixy.rlx.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="unofficial"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="unofficial"/&gt;
 * </pre>
 ...
 */
public class XmlUnofficial extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
     ...
     * @param stack
     */
    public XmlUnofficial(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public XmlUnofficial(Document doc) {
     ...
     * @param element
     */
    public XmlUnofficial(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlUnofficial</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlUnofficial</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlUnofficial</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("unofficial");
        int size;
     ...
     * for the <code>XmlUnofficial</code>.
     *
     * @param element
     * @return boolean
     */
     ...
     * is valid for the <code>XmlUnofficial</code>.
