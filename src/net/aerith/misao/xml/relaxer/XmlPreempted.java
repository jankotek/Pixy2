...
/**
 * <b>XmlPreempted</b> is generated by Relaxer based on pixy.rlx.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="preempted"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="preempted"/&gt;
 * </pre>
 ...
 */
public class XmlPreempted extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
     ...
     * @param stack
     */
    public XmlPreempted(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public XmlPreempted(Document doc) {
     ...
     * @param element
     */
    public XmlPreempted(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlPreempted</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlPreempted</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlPreempted</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("preempted");
        int size;
     ...
     * for the <code>XmlPreempted</code>.
     *
     * @param element
     * @return boolean
     */
     ...
     * is valid for the <code>XmlPreempted</code>.
