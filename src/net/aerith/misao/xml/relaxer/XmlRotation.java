...
/**
 * <b>XmlRotation</b> is generated by Relaxer based on pixy.rlx.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="rotation" type="float"/&gt;
 * &lt;tag name="rotation"&gt;
 *   &lt;attribute name="unit" required="true" type="string"/&gt;
 * &lt;/tag&gt;
 * </pre>
 ...
 */
public class XmlRotation extends net.aerith.misao.xml.IONode implements java.io.Serializable, IRNode {
     ...
     * @param stack
     */
    public XmlRotation(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public XmlRotation(Document doc) {
     ...
     * @param element
     */
    public XmlRotation(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>XmlRotation</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XmlRotation</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XmlRotation</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("rotation");
     ...
     * is valid for the <code>XmlRotation</code>.
