...
/**
 * The <code>IdentifiedStarSearchInternalFrame</code> represents a 
 * frame to select XML report documents to search stars identified 
 * with a specified catalog.
 *
 * @author  Seiichi Yoshida (comet@aerith.net)
 * @version 2007 March 11
 */

public class IdentifiedStarSearchInternalFrame extends BaseInternalFrame implements OperationObserver {
	/**
	 * The parent desktop.
	 */
	 ...
	 * The operation.
	 */
	protected IdentifiedStarSearchOperation operation;
	...
	/**
	 * Constructs a <code>IdentifiedStarSearchInternalFrame</code>.
	 * @param desktop the parent desktop.
	 */
	public IdentifiedStarSearchInternalFrame ( BaseDesktop desktop ) {
		this.desktop = desktop;

		pane = getContentPane();

		table = new InformationTable();
		operation = new IdentifiedStarSearchOperation(table);
...
//		initMenu();
	 ...
	 */
	protected void setOperation ( IdentifiedStarSearchOperation operation ) {
